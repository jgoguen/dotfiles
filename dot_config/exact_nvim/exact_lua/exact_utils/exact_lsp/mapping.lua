...
-- Taken from https://github.com/williamboman/mason-lspconfig.nvim/blob/main/lua/mason-lspconfig/mappings/server.lua
-- so I don't need to include the whole mason-lspconfig plugin just for this
-- list.
...
M.package_to_lspconfig = Utils.invert(M.lspconfig_to_package)
